...
const FormTaxRateComponent: FC<TProps> = ({
  label,
  className,
  help,
  type = "text",
  ...
  return (
    ...
    >
      ...
      <div className="position-relative">
        ...
        />
        <div className="input-control__addon">
          <span className="input-control__addon-label">%</span>
        </div>
      </div>
...
export const FormTaxRate = memo(FormTaxRateComponent);