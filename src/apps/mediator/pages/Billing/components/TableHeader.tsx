...
export const TableHeader = ({ onSort, sortData }: Props) => {
  return (
    <div className="billings-page__table-header">
      <div className="billings-page__table-header-item"></div>
      <div className="billings-page__table-header-item">
      ...
      <div className="billings-page__table-header-item sortable">
        <SortIcon
          state={sortData.matter__title}
          label="Matter"
          onClick={(state) => onSort("matter__title", state)}
        />
      </div>
      <div className="billings-page__table-header-item sortable">
        <SortIcon
