...
export const TableHeader = ({ onSort, sortData }: Props) => {
  return (
    <div className="lead-matter-document-table-header">
      <div className="lead-matter-document-table-header-item sortable">
        <SortIcon
      ...
      <div className="lead-matter-document-table-header-item">
