...
import { ISortData } from "./ContactsTable";
import "./../style.scss";

interface Props {
  onSort(row: "name", state: "up" | "down" | "normal"): void;
  sortData: ISortData;
}
export const TableHeader = ({ onSort, sortData }: Props) => {
  return (
    <div className="contacts-page__table-header">
      <div className="contacts-page__table-header-item sortable">
        <SortIcon
          state={sortData.name}
          label="Name"
      ...
      <div className="contacts-page__table-header-item">
        <span className="my-auto">Firm</span>
      </div>
      <div className="contacts-page__table-header-item">
