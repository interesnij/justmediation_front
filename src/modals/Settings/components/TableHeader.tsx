...
export const TableHeader = ({ onSort, sortData }: Props) => {
  return (
    <div className="members-page__table-header">
      <div className="members-page__table-header-item sortable">
        <SortIcon
          state={sortData.first_name}
          label="Name"
          onClick={(state) => onSort("first_name", state)}
        />
      </div>
      <div className="members-page__table-header-item">
        <span className="my-auto">Type</span>
      </div>
      <div className="members-page__table-header-item">
        <span className="my-auto">Email</span>
      </div>
      <div className="members-page__table-header-item justify-content-center">
