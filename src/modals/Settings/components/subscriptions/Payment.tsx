...
export const PaymentForm = ({ planId, onBack, subscriptionData, closeModal }: Props) => {
  const { userId, subscribe, userType, profile } = useAuthContext();
  ...
  const fee = profile?.fee_rate ? (Number(subscriptionData?.amount) / 100 * Number(profile?.fee_rate)).toFixed(2) : 0
  const totalWithFee = (Number(subscriptionData?.amount) + Number(fee)).toFixed(2)
              ...
              <div className="col-md-4">
                <Card>
                  ...
                  <div className="d-flex mt-2 justify-content-between">
                    <div className="subscription-pmnt-text">
                      <span className="capitalize">{subscriptionData?.interval}</span> charge
                    </div>
                    <strong className="text-dark">${subscriptionData?.amount}</strong>
                  </div>
                  <div className="divider my-3"/>
                  <div className="subscription-pmnt-heading">
                    Today's Charge
                  ...
                  <div className="mt-2 d-flex justify-content-between">
                    ...
                    <strong className="subscription-pmnt-text">
                      ${subscriptionData?.amount}
                    </strong>
                  </div>
                  <div className="mt-2 d-flex justify-content-between">
                    <span className="subscription-pmnt-text">Estimated Tax</span>
                    <strong className="subscription-pmnt-text">
                      ${fee}
                    </strong>
                  </div>
                  <div className="mt-2 d-flex justify-content-between">
                    ...
                    <strong className="subscription-pmnt-total">
                ...
                <Card className="mt-4">
                  ...
                  <p className="subscription-pmnt-text">
                    ...
                    {moment().add(subscriptionData?.interval === "month" ? 6 : 12, 'months').format("MMMM DD, YYYY")}.
