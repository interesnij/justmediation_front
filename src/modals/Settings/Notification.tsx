...
export const Notification = () => {
  ...
  return (
    <div className="settings settings-modal">
      <Folder label="JustMediationHub Dashboard" className="jumbo">
        {isLoading ? (
          <FolderItem>
            ...
            <FolderItem>
              <div className="row">
                <div className="col-md-6">
                  ...
                  <div className="desc">
                    Get notifications about contact related activities including
                    contact sharing and accepted invites.
                  </div>
                </div>
                <div className="col-md-6 d-flex">
                  <Switch
                    ...
                    value={contacts}
                    onChange={(e) => {
                      updateNotificationSettings({ contacts: e });
                      setContacts(e);
                    }}
                  />
                </div>
      ...
      <Folder label="Delivery Options" className="jumbo mt-3">
        {isLoading ? (
          <FolderItem>
            <div className="my-auto d-flex">
              <RiseLoader className="my-4" />
