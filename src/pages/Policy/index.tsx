    ...
    <PolicyLayout>
      ...
      <div className="d-flex flex-column flex-1 overflow-auto px-2">
        ...
        <p className="mt-0">
          ...
          your data that are specific to certain practices or features of the
          Service. The terms of those notices are to be read and understood in
          conjunction with this Privacy Policy.
        </p>
        <p className="mt-0">
          Some information collected when you access or use our Site or Service
          is considered “Personal Information.” This is information that relates
        ...
        <p className="mt-0">
          ...
          receive from you, how we use and disclose your information, and the
          steps we take to protect your information in connection with your use
          of the Site and the Service. It also tells you how you can access and
          update your information and make certain choices about how your
          information is used. By using the Site and/or Service in any manner,
        ...
        <p>
          This section describes the categories of information we collect when
          you use our Site and Service. The information we collect is provided
          by you, generated by the tracking technologies we may use.
        </p>
        <h3>2.1) Information You Provide</h3>
        <ul>
          <li>
            <i>Registration & Account Data</i>. When you register to use the
            Service or set up an account, you may provide and we may collect
          ...
          <li>
            ...
            to enable settings that allow other access to your device, such as
          ...
          <li>
            ...
            Service, you will have access to a variety of public chatrooms and
            other non-private areas of the Site or Service in which you may
            voluntarily share information, including by uploading content or
            ...
            what you post in publicly accessible areas of the Site or Service.
          </li>
          <li>
            <i>Transaction Information.</i> You may provide and we may collect
            Personal Information when you fill out forms or fields on the Site
            and within the Service and when you contact us or request
            information about us, this Site or our Service as well as when you
            purchase the Service
          </li>
          <li>
            <i> Usage Information.</i> When you visit the Site, use the Service,
            or open an email from us, we may collect and record (including
            automatically) certain information from your computer, web browser,
            mobile device and/or any devices you use that integrate with the
            Site or Service. We may combine this information across different
            devices you use. Information we obtain in this manner includes:
            <ul>
              <li>
                Identifiers and device attributes such as your IP address or
                other device address or ID, web browser and/or device type,
                hardware and software settings and configurations;
              </li>
              <li>
                Information about how you use and navigate the Site and Service,
                including the web pages or sites that you visit just before or
                just after visiting the Site, the pages you view on the Site and
                within the Service, your actions on the Site and within the
                Service, the dates and times that you visit, access, or use the
                Site and Service, which links you click on, which pages or
                content you view and for how long, and other similar information
                and statistics about your interactions with the Site and
                Service;
              </li>
              <li>
                Location information, including the physical location of your
                device. This information may be captured in a variety of ways,
                including through the use of tracking technologies such as
                Cookies (which are small files containing a string of
                alphanumeric characters) that we send to your computer or mobile
                device, web beacons or clear GIFs (which are small strings of
                code that provide a means to deliver a GIF for tracking
                purposes) that we embed on the Site, within the Service, or in
                emails we send to you, and similar technologies.
              </li>
            </ul>
          </li>
          <li>
            Cookies & Third Party Technologies. We may use a variety of cookies
            and third-party technologies to understand how you use and navigate
            the Site and Service. These may include Session, Persistent, and
            Flash Cookies and data analytics tools such as Google Analytics. A
            ...
            and may be used by your browser on subsequent visits to the Site or
            Service, including to remember your previous actions. Persistent
            Cookies can be removed. You may be able to configure your browser to
            accept or reject all Cookies or to notify you when a Cookie is set.
            Each browser is different. Please review your web browser “Help”
            file to learn the proper way to modify your Cookie settings. If you
            delete, or choose not to accept, Cookies from the Site or Service,
            you may not be able to utilize the features of the Site and Service
            to their fullest potential.
          </li>
        </ul>
        <p className="mt-0">
          Please note that “flash” Cookies are different from “browser” Cookies
          because of the way in which flash Cookies capture and store data. Your
          browser’s Cookie management tools will not remove flash Cookies. To
          learn how to manage privacy and storage settings for Flash Cookies
          click here:{" "}
          <a href="http://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager.html#117118">
            http://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager.html#117118
          </a>
          . We may use flash Cookies to provide some content such as video or
          animation.
        </p>
        <p className="mt-0">
          You may also visit the websites of the Network Advertising Initiative
          (
          ...
          ) for general information about your choices with respect to how
          information about your online activities is used.
        </p>
        <h3 className="mb-0">2.2) Information We Collect from Third Parties</h3>
        <p>[●]</p>
        <h2 className="mb-0">3) How We Use Information We Collect</h2>
        <p>
          This section describes the ways we use the various categories of
          information, described above, to operate our Site and Service.
        </p>
        <h3 className="mb-0">3.1) Information You Give to Us</h3>
        <p>
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                <td>Registration and Account Information</td>
                <td></td>
              </tr>
              <tr>
        ...
        <p>
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td>Cookies & Third-Party Technologies</td>
                <td>
                  <div>
                    Operate, maintain, enhance, and provide all of the features
                    of the Site and Service;
                  </div>
                  <div>
                    Understand and analyze the usage trends and preferences of
                    our users, to improve the Site and Service, and to improve
                    fraud detection and information security;
                  </div>
                  <div>
                    Personalize the Site and Service, such as by remembering
                    your information and providing customized content;
                  </div>
                  <div>
                    Run analytics and study traffic patterns on the Site and
                    Service, including to monitor and analyze the effectiveness
                    of the Site and Service;
                  </div>
                  <div>
                    Tell if an email has been opened and acted upon; and
                  </div>
                  <div>Direct advertisements to you.</div>
                </td>
              </tr>
              <tr>
                <td>[●]</td>
        ...
        <p>
          <div>Information We Collect From Third Parties</div>
          <table>
            <thead>
              <tr>
                <th>Categories of Personal Data </th>
        ...
        <p>
          We do not sell your Personal Information. To make the Site and Service
          work, we may need to share your personal information with other users,
        ...
        <p>
          ...
          operations and the provision of the Site and Service.
          <ul>
            <li>
              Your Public Contributions will be available to anyone who is able
              to access that content, including other users of the Site or
              Service. We (as well as others with access to the information over
              whom we may not have any influence or control) may collect, store,
              and use this information in any way.
            </li>
            <li>
              We work with third party service providers to help us run our
              business. These third party service providers provide services
              that include (without limitation) website and application
              development and support, payment processors and financial services
              providers, IT providers (including hosting providers such as
              Amazon Web Services and support and maintenance providers), data
              storage, maintenance, legal advisors and other professional
              services, and marketing and promotions management. To the extent
              it is necessary for these third party service providers to
              complete their contractual obligations to us, these third parties
              may have access to or process your information. All third party
              service providers that process your personal information on our
              behalf are contractually obligated to respect the confidentiality
              of such personal information. These third party service providers
              may be located in a jurisdiction that does not provide the same
              level of data protection as the jurisdiction in which you reside.
            </li>
          </ul>
        </p>
        <h3>
          4.2) Compliance with Law, Responding to Legal Requests, and Protecting
          Our Rights
        </h3>
        ...
        <ul>
          <li>
            ...
            such action is necessary to comply with law (including copyright
            law), in response to a court order, judicial or other government
            subpoena or warrant, or to otherwise cooperate with law or
            government enforcement activity;
          </li>
          <li>
            in our good faith belief that doing so is appropriate or necessary
            to take precautions against liability and/or to investigate and
        ...
        <ul>
          <li>
            ...
            necessary to comply with law, a court order, subpoena or warrant, or
            otherwise to cooperate with law enforcement, regulators,
          ...
          <li>
            disclosure to our hosting providers, including Amazon Web Services,
          ...
          <li>
            ...
            transaction or in contemplation of such transaction (e.g., due
            diligence) with or to buyers or purchasers (or potential buyers or
        ...
        <ul>
          ...
          <li>
            ...
            will be reflected promptly in active databases but we may retain all
            information you submit for a variety of purposes, including backups
            and archiving, prevention of fraud and abuse, and analytics.
          </li>
        </ul>
        ...
        <p>
          ...
          <p>
            ...
            <ul>
              <li>
                request access to the specific pieces and categories of Personal
                Information that we have collected about you over the past
                twelve months, the categories of sources of that information,
                our business or commercial purposes for collecting the
                information, and the categories of third parties with whom the
                information was shared;
              </li>
              <li>
                submit a request for deletion of Personal Information, subject
                to certain exceptions, including (without limitation) in the
                event that we may need to retain Personal Information to
                complete the transaction for which the Personal Information was
                collected, detect security incidents or protect against illegal
                activity, exercise free speech, comply with a legal obligation,
                or for lawful internal use compatible with the context in which
                the information was provided by you. If your request is subject
                to any exception, we may deny your request to delete your data.
          ...
          To exercise these rights, you may contact us at: +1 212 220 6580. You
          have the right not to be discriminated against for exercising your
        ...
        <h2>6) Security</h2>
        <p>
          We employ appropriate safeguards that are designed to protect the
          integrity and security of your information. No security measures are
          perfect or impenetrable, however, so we cannot ensure or warrant the
          security of any information you transmit to us through the Site or
          ...
          by breach of any of our safeguards. We cannot control the actions of
          other users or other third parties with whom you may choose to share
          your information and therefore we cannot and do not guarantee that
          information you post through the Site or Service will not be viewed by
          unauthorized persons. We are not responsible for circumvention of any
          privacy settings or security measures contained on the Site or in the
          Service.
        </p>
        <p>
        ...
        <p>
          ...
          If you access or use the Site or Service from outside the United
          States, including (without limitation) from member states of the
          European Union, you acknowledge and unambiguously consent to the
          transfer of your information to, and its processing and storage in,
          the United States and potentially other jurisdictions that may not
          provide the same level of privacy and data protection as your home
          jurisdiction.
        </p>
        <p>
          Depending on the jurisdiction in which you reside, you may have the
          right to access, correct, delete, or restrict use of certain Personal
          Information covered by this Privacy Policy. Depending on the
          jurisdiction, you may also have the right to request that we refrain
          from processing your Personal Information. Please bear in mind that if
          ...
          it may take some time to process your request, consistent with
          applicable law.
        </p>
        <h3>7.2) Limitation of Liability</h3>
        By accessing this Site or Service and/or otherwise providing us with
        Personal Information and other data, you expressly and unconditionally
        ...
        the use and/or misuse of such information. In addition, while we make
        efforts to ensure the proper and appropriate use of data by our service
        providers that may receive your information from us, we are not
        responsible for any injuries, loss, or damage of any kind arising from
        or in connection with the use and/or misuse of your information caused
        by those service providers.
        <h3>7.3) Third-Party Content</h3>
        Third-party content may be linked to or otherwise incorporated into the
        Site or the Service. For example, we may implement or allow third party
        advertising or other content on the Site and within the Service that may
        utilize web beacons, Cookies or similar tracking technologies placed or
        controlled by the third-party content provider. Additionally, we may
        ...
        <h3>7.4) Do Not Track Disclosures</h3>
        Third parties such as advertising networks, analytics providers, and
        others may collect information about your online activities over time
        and across different websites when you access or use the Site or
        Service. Currently, various browsers offer a Do Not Track (“DNT”)
        option, but there is no standard for how DNT should work on commercial
        websites. Due to lack of such standards, the Site does not respond to Do
        Not Track browser settings.
        <h3>7.5) Children’s Data</h3>
        <p>
          Protecting the privacy of young children is especially important. For
          that reason, we do not allow children under 13 years of age to use the
          Site or Service, we do not knowingly collect or maintain information
          from persons under 13 years of age, and no part of the Site or Service
          is directed to persons under 13 years of age. If you are under 13
          years of age, then please do not use or access the Site or Service at
          any time or in any manner. If we learn that information has been
          collected through the Site or Service from persons under 13 years of
        ...
        We will notify you about material changes in the way we treat your
        ...
        the Site or Service. Material modifications are effective 30 calendar
        days after our initial notification or upon your acceptance of the
        modified Privacy Policy. Immaterial modifications are effective upon
        posting of the updated Privacy Policy on the Site. Please revisit this
        page periodically to stay aware of any changes to this Privacy Policy.
        For the avoidance of doubt, disputes arising hereunder will be resolved
        in accordance with the Privacy Policy in effect at the time the dispute
        arose.
        <h3>9) Contact Us</h3>
        <p>
