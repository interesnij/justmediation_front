...
import { ISortData } from "./TemplatesTable";
import "./style.scss";
...
export const TableHeader = ({ onSort, sortData }: Props) => {
  return (
    <div className="templates-page__table-header">
      <div className="templates-page__table-header-item sortable">
        <SortIcon
      ...
      <div className="templates-page__table-header-item">
