...
export const TableHeader = ({ onSort, sortData }: Props) => {
  return (
    <div className="my-documents-page__table-header">
      <div className="my-documents-page__table-header-item sortable">
        <SortIcon
      ...
      <div className="my-documents-page__table-header-item">
        <span className="my-auto">Matter</span>
      </div>
      <div className="my-documents-page__table-header-item">
      ...
      <div className="my-documents-page__table-header-item ml-auto">
