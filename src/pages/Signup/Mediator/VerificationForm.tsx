  ...
  return (
    <SignupLayout>
      ...
      <div className="desc mx-auto mt-3">
        To become a verified mediator on JustMediationHub, we need to validate the
            ...
            <Form>
              ...
              <Folder className="mt-4" label="Jurisdictions">
                <FolderItem>
                  ...
                  <span className={`error-text ${isShowingAlert ? 'alert-shown' : 'alert-hidden'}`} onTransitionEnd={() => {setShowingAlert(false)}}>Please input your Jurisdiction</span>
                </FolderItem>
              </Folder>
              <Folder
                className="mt-4"
